...
cp -f "${ROOTDIR}/mqx/source/bsp/imx6sx_ai_m4/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
cp -f "${ROOTDIR}/config/imx6sx_ai_m4/user_config.h" "${OUTPUTDIR}/../user_config.h"
cp -f "${ROOTDIR}/mqx/source/io/sensor/mma8451q/mma8451q_basic.h" "${OUTPUTDIR}/mma8451q_basic.h"
cp -f "${ROOTDIR}/mqx/source/bsp/imx6sx_ai_m4/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
cp -f "${ROOTDIR}/mqx/source/io/can/flexcan/fsl_flexcan_hal.h" "${OUTPUTDIR}/fsl_flexcan_hal.h"
cp -f "${ROOTDIR}/mqx/source/bsp/imx6sx_ai_m4/imx6sx_ai_m4.h" "${OUTPUTDIR}/imx6sx_ai_m4.h"
cp -f "${ROOTDIR}/mqx/source/bsp/imx6sx_ai_m4/bsp.h" "${OUTPUTDIR}/bsp.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/imx6sx_ai_m4/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
...
if [ "${TOOL}" = "iar" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/imx6sx_ai_m4/iar/ram.icf" "${OUTPUTDIR}/ram.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/imx6sx_ai_m4/iar/extflash.icf" "${OUTPUTDIR}/extflash.icf"
...
if [ "${TOOL}" = "ds5" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/imx6sx_ai_m4/ds5/ram.scf" "${OUTPUTDIR}/ram.scf"
cp -f "${ROOTDIR}/mqx/source/bsp/imx6sx_ai_m4/ds5/extflash.scf" "${OUTPUTDIR}/extflash.scf"
mkdir -p "${OUTPUTDIR}/Generated_Code"
mkdir -p "${OUTPUTDIR}/Sources"
:
fi
...
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/imx6sx_ai_m4/gcc_arm/ram.ld" "${OUTPUTDIR}/ram.ld"
cp -f "${ROOTDIR}/mqx/source/bsp/imx6sx_ai_m4/gcc_arm/extflash.ld" "${OUTPUTDIR}/extflash.ld"
mkdir -p "${OUTPUTDIR}/Generated_Code"
mkdir -p "${OUTPUTDIR}/Sources"
:
fi
