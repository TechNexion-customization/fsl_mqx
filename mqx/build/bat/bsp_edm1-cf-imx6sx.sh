...
cp -f "${ROOTDIR}/mqx/source/bsp/edm1-cf-imx6sx/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/edm1-cf-imx6sx/edm1-cf-imx6sx.h" "${OUTPUTDIR}/edm1-cf-imx6sx.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/edm1-cf-imx6sx/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
...
cp -f "${ROOTDIR}/config/edm1-cf-imx6sx/user_config.h" "${OUTPUTDIR}/../user_config.h"
...
cp -f "${ROOTDIR}/mqx/source/bsp/edm1-cf-imx6sx/bsp.h" "${OUTPUTDIR}/bsp.h"
cp -f "${ROOTDIR}/mqx/source/bsp/edm1-cf-imx6sx/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
...
if [ "${TOOL}" = "iar" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/edm1-cf-imx6sx/iar/ram.icf" "${OUTPUTDIR}/ram.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/edm1-cf-imx6sx/iar/extflash.icf" "${OUTPUTDIR}/extflash.icf"
...
if [ "${TOOL}" = "ds5" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/edm1-cf-imx6sx/ds5/ram.scf" "${OUTPUTDIR}/ram.scf"
cp -f "${ROOTDIR}/mqx/source/bsp/edm1-cf-imx6sx/ds5/extflash.scf" "${OUTPUTDIR}/extflash.scf"
mkdir -p "${OUTPUTDIR}/Generated_Code"
mkdir -p "${OUTPUTDIR}/Sources"
:
fi
...
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/edm1-cf-imx6sx/gcc_arm/ram.ld" "${OUTPUTDIR}/ram.ld"
cp -f "${ROOTDIR}/mqx/source/bsp/edm1-cf-imx6sx/gcc_arm/extflash.ld" "${OUTPUTDIR}/extflash.ld"
mkdir -p "${OUTPUTDIR}/Generated_Code"
mkdir -p "${OUTPUTDIR}/Sources"
:
fi
