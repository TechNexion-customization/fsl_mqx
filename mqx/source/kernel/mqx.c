...
#define IDLE_TASK_EXTRA_STACK_SIZE  0x80
...
const uint32_t          _mqx_version_number = 0x04010000;
const char      *const _mqx_vendor         = "Freescale/Freescale MQX";

/* Identify the product */
#if MQX_CRIPPLED_EVALUATION
const char      *const _mqx_version        = "4.1.0c";
#else
const char      *const _mqx_version        = "4.1.0";
#endif
...
{ /* Body */
    ...
    task_template_ptr->TASK_STACKSIZE      = PSP_IDLE_STACK_SIZE + IDLE_TASK_EXTRA_STACK_SIZE;
