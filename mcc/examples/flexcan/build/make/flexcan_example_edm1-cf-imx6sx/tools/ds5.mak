...
LIBRARIES += $(MQX_ROOTDIR)/lib/edm1-cf-imx6sx.ds5/debug/mcc/mcc.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/edm1-cf-imx6sx.ds5/release/mcc/mcc.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/edm1-cf-imx6sx.ds5/debug/mcc
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/edm1-cf-imx6sx.ds5/release/mcc
endif
